...
RcppExport SEXP _missMS_gibbsCpp(SEXP y_listSEXP, SEXP y_miss_SEXP, SEXP r_obs_SEXP, SEXP matListSEXP, SEXP pointersSEXP, SEXP fcs_SEXP, SEXP peps_SEXP, SEXP int_mu_SEXP, SEXP miss_a_SEXP, SEXP miss_b_SEXP, SEXP sigma_SEXP, SEXP tau_int_SEXP, SEXP tau_fc_SEXP, SEXP tau_pep_SEXP, SEXP yVec_SEXP, SEXP rProbitSEXP, SEXP rsnSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(gibbsCpp(y_list, y_miss_, r_obs_, matList, pointers, fcs_, peps_, int_mu_, miss_a_, miss_b_, sigma_, tau_int_, tau_fc_, tau_pep_, yVec_, rProbit, rsn));
